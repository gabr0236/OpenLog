...
public class LineGraph {
    ...
    List<Pair<Integer, Date>> dataSet;
    org.eazegraph.lib.charts.ValueLineChart cubicValueLineChart;
    ValueLineSeries series = new ValueLineSeries();

    public LineGraph(List<Pair<Integer, Date>> dataSet, ValueLineChart cubicValueLineChart) {
        this.dataSet = dataSet;
        this.cubicValueLineChart = cubicValueLineChart;
        setValues(dataSet);
    }

    public void setValues(List<Pair<Integer, Date>> newDataSet) {
        ...
        if (dataSet.size() > 1) {
            ...
            for (Pair<Integer, Date> pair : dataSet) {
